...
for(i in 1:nrow(data)){
  ...
  if(is.integer0(CL0.values)){CL0.values=NA}else{CL0.values=CL0.values/10}
  if(is.integer0(CL1.values)){CL1.values=NA}else{CL1.values=CL1.values/10}
  if(is.integer0(CL2.values)){CL2.values=NA}else{CL2.values=CL2.values/10}
  if(is.integer0(CL3.values)){CL3.values=NA}else{CL3.values=CL3.values/10}
  if(is.integer0(CL4.values)){CL4.values=NA}else{CL4.values=CL4.values/10}
  if(is.integer0(CL5.values)){CL5.values=NA}else{CL5.values=CL5.values/10}
...
write.csv(df,"Backwardation_for_Gold.csv.csv")
